import{r,j as n}from"./index-DandlkV_.js";import{c as U,G as L}from"./client-CLbbz6m0.js";const a=new L("https://irkwbvxjbynhlcascmrk.hasura.eu-central-1.nhost.run/v1/graphql",{headers:{"x-hasura-admin-secret":"b0oJ5NWT^GXk8=O+mdV=X2yzz1D5AgWX"}}),N=U({url:"https://irkwbvxjbynhlcascmrk.hasura.eu-central-1.nhost.run/v1/graphql".replace("https","wss"),connectionParams:{headers:{"x-hasura-admin-secret":"b0oJ5NWT^GXk8=O+mdV=X2yzz1D5AgWX"}}}),B=()=>{const f=r.useRef(null),[w,m]=r.useState([]),[E,c]=r.useState([]),[p,q]=r.useState(""),[_,h]=r.useState(!1),[g,b]=r.useState(""),[t,G]=r.useState("es"),T=t==="de"?"Senden":t==="es"?"Enviar":t==="en"?"Send":"Envoyer",O=t==="de"?"Hier eingeben":t==="es"?"Escribe aquí":t==="en"?"Type here":"Tapez ici",x=t==="de"?"Virtueller Assistent":t==="es"?"Asistente virtual":t==="en"?"Virtual assistant":"Assistant virtuel",$=t==="de"?"Ich":t==="es"?"Yo":t==="en"?"Me":"Moi",y=t==="de"?"de-DE":t==="es"?"es-ES":t==="en"?"en-US":"fr-FR",j=`
